...
with open(list_file_path, 'wb') as list_file:
    for root, subdirs, files in os.walk(walk_dir):
        ...
        i=0
        for filename in [filename for filename in files if not("._" in filename) and (filename.endswith(".jpg") or filename.endswith(".jpeg") or filename.endswith(".JPG") or filename.endswith(".JPEG") or filename.endswith(".png"))]:
